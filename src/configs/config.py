...
_C.MODEL.ADAPTER.TYPE = "Pfeiffer"
_C.MODEL.ADAPTER.BOTTLENECK = 16
_C.MODEL.ADAPTER.ACTIVATION = "gelu"
_C.MODEL.ADAPTER.DROPOUT = 0.0
_C.MODEL.ADAPTER.SCALE = 1.0
_C.MODEL.ADAPTER.LN_BEFORE = False
_C.MODEL.ADAPTER.LN_AFTER = False
...
# IA3 options
# ----------------------------------------------------------------------
_C.MODEL.IA3 = CfgNode()

# ----------------------------------------------------------------------
# SSF options
# ----------------------------------------------------------------------
_C.MODEL.SSF = CfgNode()
